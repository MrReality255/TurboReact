import { StrUtils, useLayers } from '@mrreality255/turbo-react-forms'
import {
    TButton,
    TColLayout,
    THeading,
            ...
            <TRowLayout>
                ...
                <TViewport height={'200px'}>
                    <TWindow caption="Vertical layout" fill>
                        ...
                        >
                            <p>
                                Some text in the main window. It has to be long
                                so you can see that this block is getting a
                                scroll bar. But you still can see the header and
                                the footer.
                            </p>
                            <p>
                                Some text in the main window. It has to be long
                ...
                <TWindow border="none" innerPadding="space">
                    ...
                    <TButton
                        w1
                        onClick={() => {
                            n.main.showNotification(() => (
                                <TNotification palette="green">
                                    Something succeeded in this reality.
                                </TNotification>
                            ))
                        }}
                    >
                    ...
                    <TButton
                        ...
                        onClick={() => {
                            n.main.showNotification(() => (
                                <TNotification palette="red">
                                    Something failed in this reality.
                                </TNotification>
                            ))
                        }}
                    >
                    ...
                    <TColLayout cols={2} gap={'5em'}>
                        <TRowLayout>
                            <TNameValue
                                actionWidth={'75px'}
                                action={
                                    <TButton variant="text">Action</TButton>
                                }
                                name="Property 1"
                            >
                                Value 1 with very very very long content so it
                                makes sure it has more than one line in the
