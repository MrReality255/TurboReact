...
import { LoadingBar } from '../turbo-react/atoms/LoadingBar';
...
import { VertLayout } from '../turbo-react/layout/VertLayout';
    ...
    <DemoAppLayout selected="misc">
      <RowLayout>
        ...
        <Window caption="Horizontal layout">
          ...
          <HorizLayout alignMode="right" gap={'5em'} left={<p>Some text on the left side</p>}>
            <p>Some context on the right side</p>
          </HorizLayout>
        </Window>
        <Viewport height={'200px'}>
          <Window caption="Vertical layout" fill>
            ...
            >
              <p>
                Some text in the main window. It has to be long so you can see that this block is getting a scroll bar.
                But you still can see the header and the footer.
              </p>
              <p>
                Some text in the main window. It has to be long so you can see that this block is getting a scroll bar.
                But you still can see the header and the footer.
        ...
        <Window>
          <ColLayout cols={2} gap={'5em'}>
            <RowLayout>
              <NameValue actionWidth={'75px'} action={<Button variant="text">Action</Button>} name="Property 1">
                Value 1 with very very very long content so it makes sure it has more than one line in the window being
                displayed.
              </NameValue>
