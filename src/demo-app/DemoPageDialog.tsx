                    ...
                    <TButton
                        ...
                        onClick={async () => {
                            const result = await myDlg.show(
                                ...
                                {
                                    ctxContent:
                                        'a value passed to the show function',
                                }
                            )
                            setData(
                                JSON.stringify(
            ...
            <TForm context={frm}>
                ...
                <TRowLayout gap="5px">
                    <TFormField
                        ...
                        id="btn1"
                        caption="Button"
                        buttonProps={{ w1: true, palette: 'red' }}
                    ></TFormField>
                    <TFormField
                        type="toggle"
                        id="btn2"
