...
export function DemoPageWindows() {
  ...
  return (
    <DemoAppLayout selected="windows">
      ...
      <Viewport rect={{ x: '0em', y: '10.5em', x2: '0em', y2: '0em' }} scrollbar>
        <Window caption="Window with auto size" palette="dark">
          It has some content. Its height is automatic.
        </Window>
        <div style={{ marginTop: '1em' }}>
          <Window caption="Error message" palette="red" innerPadding="space" border="single">
            Some error occurred.
          </Window>
        </div>
        <div style={{ marginTop: '1em' }}>
        ...
        <div style={{ marginTop: '1em' }}>
          {isVisible && (
            <Window caption="Some other window" palette="green" onClose={() => handleClose()}>
