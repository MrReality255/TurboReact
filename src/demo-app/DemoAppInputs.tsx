  ...
  return (
    <DemoAppLayout selected="textboxes">
      <PalettePanel lineHeight="22.5em">
        <TRowLayout gap={10}>
          <TTextBox caption="Standard" value={value} onChange={(v) => setValue(v)}></TTextBox>
          <TTextBox caption="Disabled" value="some value" disabled></TTextBox>
          <TTextBox caption="With prefix" prefix="$" mode="number"></TTextBox>
          <TTextBox caption="With suffix" align="right" value="200,30" disabled suffix="€"></TTextBox>
          <TTextBox caption="Both prefix and suffix" align="center" prefix="$" suffix="€"></TTextBox>
        </TRowLayout>
      </PalettePanel>
    </DemoAppLayout>
  );
  ...
  return (
    <DemoAppLayout selected="inputs">
      <PalettePanel lineHeight="26em">
        ...
        <TProgressBar value={prgValue} onChange={(v) => setPrgValue(v)} caption="Progress" showValue></TProgressBar>
        <TProgressBar value={prgValue} caption="Progress - second value"></TProgressBar>
        <TProgressBar
