					...
					<div>
						{wrapperFct(
							<FormFieldControl
								...
								disabled={disabled}></FormFieldControl>,
							item,
							p,
							p.onAction
								? (id, customData) => {
		...
		case "dropdown":
			return (
				<DropDown
					...
					defaultValue={p.defaultValue}
					disabled={p.disabled}
					onChange={(value) => update(value)}></DropDown>
			);
		case "form":
			return (
				<Form
		...
		case "progress":
			return (
				<ProgressBar
					...
					defaultValue={p.defaultValue}
					disabled={p.disabled}
					onChange={(value) => update(value, true)}></ProgressBar>
			);
		case "template":
